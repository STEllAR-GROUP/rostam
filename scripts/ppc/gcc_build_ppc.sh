...
usage()
{
    ...
    echo
    echo "This script downloads and builds GCC on Power8."
    echo
    echo "Options:"
...
echo "prepend-path    LD_LIBRARY_PATH         \$root/lib/gcc/ppc64le-redhat-linux/$VERSION" >> $MODULE_DIRECTORY/gcc/$VERSION
